...
- **Fonts**: I'm using [Atkinson Hyperlegible](https://www.brailleinstitute.org/freefont/), [Luciole](https://luciole-vision.com/en/index.html) and [0xProto](https://github.com/0xType/0xProto) (hosted here and not on Google Fonts).

...
- **Fonts**: I'm using [Reforma](https://pampatype.com/reforma), [Atkinson Hyperlegible](https://www.brailleinstitute.org/freefont/) and [0xProto](https://github.com/0xType/0xProto) (hosted here and not on Google Fonts).
